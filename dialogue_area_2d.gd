...
var dialogue_top_pos: Vector2 = Vector2(160,-50)
var dialogue_bottom_pos : Vector2 = Vector2(130,473)
...
func _activate_dialogue()-> void:
	...
	var canvaslayer = get_tree().get_first_node_in_group("CLayer")
	canvaslayer.add_child(new_dialogue)
#	get_parent().add_child(new_dialogue)
	#var cam =  get_viewport().get_camera_2d()
	#cam.target = new_dialogue
